...
public class UserDaoImpl implements UserDao {
	...
	public String signUp(User newUser) throws SQLException {
		...
		pst2.setString(2,newUser.getLastName());// 2 -in param index
		pst2.setString(3,newUser.getEmail());// 3 -in param index
		pst2.setString(4,newUser.getPassword());// 4 -in param index
		pst2.setDate(5,newUser.getDob());// 5 -in param index
		pst2.setBoolean(6,false);// 6 -in param index
		pst2.setString(7,"voter");// 7 -in param index
