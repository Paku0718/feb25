...
const ConfirmPage = () => {
    return (
        <>
            <main className="container mx-auto mt-8 flex items-center justify-center bg-teal-50 mb-24">
                <section className="max-w-md mx-auto text-center h-full">
                    <h2 className="text-3xl font-bold mb-8 text-teal-800">Order Verification</h2>
                    <div className="bg-white p-8 rounded-lg shadow-lg h-full flex flex-col justify-center min-h-80 w-96">
                        ...
                        <a href="/" className="bg-teal-800 text-white py-2 px-0 mx-8 rounded-lg font-semibold mt-20 hover:bg-teal-600">Go to Home</a>
                    </div>
                </section>
            </main>
        </>
